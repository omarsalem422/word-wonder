...
def print_word_list(label, word_list, words_per_line=8):
    """
...
if __name__ == "__main__":
    ...
    # Load the English word list for filtering, then display both the full
    # unique-word set and the English-only subset, 4 words per line each.
